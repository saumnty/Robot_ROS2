...
**Solución:** Copia y pega el siguiente código directamente en la Command Window (la consola de comandos) de MATLAB y presiona Enter. Esto agregará la ruta al motor interno de Python. (_Nota: Si prefieres, puedes cambiar `pwd` por tu ruta absoluta, ej: `'/home/usuario/mis_robots/bolitabot'`_):
